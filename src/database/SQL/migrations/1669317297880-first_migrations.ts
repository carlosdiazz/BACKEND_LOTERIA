...
export class firstMigrations1669317297880 implements MigrationInterface {
  name = 'firstMigrations1669317297880';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "loterias" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "abreviatura" character varying NOT NULL, "img_url" character varying NOT NULL, "descripcion" character varying NOT NULL, "prueba_leni" character varying, "create_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_08cf3ed4e72faf9e567c09b5102" UNIQUE ("name"), CONSTRAINT "UQ_c53f058bb29ef5d949f3bb2da1e" UNIQUE ("abreviatura"), CONSTRAINT "PK_71613e8c0e480eb1d8e73f3ce41" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
